...
namespace Materials.mykitboxDataSet5TableAdapters {
    ...
    public partial class partTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM `part` WHERE ((`code` = @p1) AND (`ref` = @p2) AND (`dimension` = @p3) AND (`height` = @p4) AND (`depth` = @p5) AND (`width` = @p6) AND (`color` = @p7) AND (`min_stock` = @p8) AND (`real_quantity` = @p9) AND (`virtual_quantity` = @p10) AND (`command_quantity` = @p11) AND (`client_price` = @p12) AND (`box_number` = @p13))";
